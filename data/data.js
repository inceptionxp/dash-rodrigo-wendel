...
const MATERIAIS_PENDENTES = [
  {categoria: '⚡ Prioritário — definido na call de 02/07', itens: ['Lista de conteúdos mínimos (diagnóstico + tratamento)', 'As 3 escadas de tratamento (muscular, articular, deslocamento de disco) — marcando o que capacita × o que é só teoria', 'Material/aula gravada dos dois tripés (sistêmico e local)', 'Números de autoridade: especialistas por turma, alunos totais, pacientes atendidos, formulários de anamnese, avaliações/ano', 'Nome da consultora high ticket (a do conselho dos vídeos) e da conhecida da especialização MEC 100% online', 'Vídeo-depoimento da paciente da peregrinação', 'Jargões e expressões que for lembrando']},
