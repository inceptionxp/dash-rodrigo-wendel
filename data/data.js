...
const ACOMPANHAMENTO = {
  ...
  historico: [
    ...
    {item: 'Material recebido: "Primeira Consulta com a Narrativa" (PPTX, o script real de conversão do Rodrigo na clínica) — extraído e analisado. É o artefato-fonte da Etapa 3 (E36-38: avaliação → apresentação → fechamento). Ticket real R$4.500/tratamento corrobora o estudo de preço', data: '28/07/2026'},
    {item: 'Rodrigo respondeu (áudio) às 3 lacunas da narrativa: (1) o "CPAD/6 fases" NÃO é framework dele — veio de mentoria de vendas da qual ele se distancia; fica só a verdade clínica "DTM é progressiva e piora sem tratar", sem urgência fabricada; (2) sem régua fixa de desconto — cada um calibra pela própria margem; (3) na explicação da dor, 3 pontos na linguagem do paciente, sem dar aula. Aplicado à análise da Etapa 3', data: '28/07/2026'},
  ],
};
