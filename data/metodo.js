...
FRAMEWORKS: [
  ...
  },
  {
    ...
    falta: ['Definir o formato da prática de agulhamento na imersão (infiltração anestésica e dry needling) — o Rodrigo levantou em 28/07 que não consegue garantir um paciente por aluno; opções em avaliação: prática entre os próprios alunos, demonstração em rotação, ou paciente real conforme disponibilidade'],
