...
FRAMEWORKS: [
  ...
  },
  {
    ...
    como_funciona: [
      ...
      'CAPACITA × SÓ-TEORIA (confirmado pelo Rodrigo em 04/07). CAPACITA A FAZER: todos os conservadores das 3 escadas + infiltração anestésica e dry needling (muscular) + infiltração de ácido hialurônico (disco e articular) + corticoide (articular). SÓ TEORIA (conhece a indicação e encaminha): toxina botulínica (muscular); artrocentese + cirúrgicos (disco: artroscopia, discopexia); artrocentese + cirúrgicos (articular: artroscopia, cirurgia aberta, prótese de ATM). A confirmar: iPRF/agregado plaquetário guiado por ultrassom (não citado na resposta — na call ele indicou como só teoria).',
    ],
    ...
    falta: ['Confirmar um único ponto: o iPRF/agregado plaquetário (articular) entra como capacita ou fica só teoria (na call ele sinalizou só teoria)'],
