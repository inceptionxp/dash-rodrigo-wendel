...
GRADE_ETAPAS: [
  {
    ...
    faixa: 'azul',
    nota: 'A etapa fecha com a imersão presencial de 3 dias em Brasília (Encontros 13-15) — palpação hands-on, medidas de movimento e integração diagnóstica, terminando no GATE + cerimônia de faixa azul.',
  },
  {
  ...
  },
  {
    ...
    faixa: 'marrom',
    nota: 'A etapa fecha com a imersão presencial final (Encontros 42-43): workshop de gestão/comercial/lucro (dia 1) seguido das apresentações finais, do GATE e da cerimônia de formatura + pitch da mentoria (dia 2).',
  },
],
