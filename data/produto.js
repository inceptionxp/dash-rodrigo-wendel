...
ENCONTROS: [
  ...
  { n: 23, etapa: 2, bloco: 'Bloco 1 · Escada Muscular (6 semanas)', titulo: 'Invasivo: a toxina no lugar certo da escada', essencia: 'A bandeira central do método: por que a toxina é o ÚLTIMO recurso, não o primeiro — "tem onda que é marola e tem onda que é tsunami". Só teoria: o aluno conhece a indicação e não executa.', output: 'Parecer escrito comparando casos de uso indevido com o caso de indicação correta.', fmt: 'online' },
  ...
  { n: 26, etapa: 2, bloco: 'Bloco 2 · Escada Deslocamento de Disco (4 semanas)', titulo: 'Minimamente invasivo: ácido hialurônico e artrocentese', essencia: 'O que cada procedimento resolve (lubrificação × lavagem articular). Ácido hialurônico: o aluno SAI CAPACITADO (prática). Artrocentese: só teoria — conhece a indicação e encaminha.', output: 'Ácido hialurônico: checklist de execução. Artrocentese: parecer de indicação.', fmt: 'online', nota: '✓ Confirmado pelo Rodrigo (04/07): ácido hialurônico entra como prática; artrocentese fica só teoria.' },
  ...
  { n: 30, etapa: 2, bloco: 'Bloco 3 · Escada Articular (4 semanas)', titulo: 'Minimamente invasivo I: corticoide e artrocentese', essencia: 'Corticoide intra-articular (limites e riscos do uso repetido) + a mesma artrocentese com racional distinto do bloco anterior. Corticoide: prática (capacita). Artrocentese: só teoria (conhece e encaminha).', output: 'Corticoide: checklist de execução. Artrocentese: parecer de indicação comparando as 2 escadas.', fmt: 'online' },
  { n: 31, etapa: 2, bloco: 'Bloco 3 · Escada Articular (4 semanas)', titulo: 'Minimamente invasivo II: iPRF e ácido hialurônico', essencia: 'Ácido hialurônico: o aluno SAI CAPACITADO (prática). iPRF/agregado plaquetário guiado por ultrassom: alta complexidade — a confirmar se fica só teoria (indicação), como o Rodrigo sinalizou na call ("a execução é território da mentoria").', output: 'Ácido hialurônico: checklist de execução. iPRF: ficha de indicação + como explicar ao paciente.', fmt: 'online', nota: '⚠️ Único ponto a confirmar da marcação capacita×teoria: o iPRF entra como prática ou fica só teoria?' },
