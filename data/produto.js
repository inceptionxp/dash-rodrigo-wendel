...
FORMACAO: {
  html: `
    <p class="page-lead">A visão geral do produto principal — o que é, o formato, as 3 etapas e o que ainda se decide junto. O detalhe vive nas subpáginas logo abaixo. Naming, formato e a estrutura das 3 imersões presenciais foram validados na call de 11/07 — o que segue em aberto é o detalhe técnico da grade, em revisão com o Rodrigo.</p>
    ...
    <div class="card">
      <dl class="kv">
        ...
        <dt>Presencial</dt><dd><strong>3 imersões presenciais obrigatórias em Brasília</strong>, uma fechando cada etapa — 8 dias de hands-on no total (diagnóstico, tratamento e o workshop final de gestão/comercial + formatura). Zero presencial opcional: as 3 são o próprio gate de passagem de faixa da etapa.</dd>
        ...
        <dt>Duração</dt><dd>10 meses · 43 encontros (35 online + 3 imersões presenciais) em 3 etapas (ver Grade)</dd>
    ...
    <ul class="entregas-lista">
      <li><strong>Etapa 1 · Diagnóstico (~4 meses · 15 encontros)</strong><em>Fundamentação + anamnese profunda (ficha de 40 perguntas e escuta clínica) + exame físico protocolar + interpretação de imagem — fechando com a IMERSÃO PRESENCIAL (3 dias em Brasília) de palpação, medidas de movimento e integração diagnóstica em paciente real. Gate ao vivo, na imersão: "todo aluno sabe dar diagnóstico". Sem diagnóstico não há tratamento nem receita.</em></li>
      <li><strong>Etapa 2 · Tratamento (~4-5 meses · 20 encontros)</strong><em>Os dois tripés aplicados + as 3 escadas de tratamento (muscular, articular, deslocamento de disco), diagnóstico a diagnóstico, do conservador ao invasivo + timing de intervenção — fechando com a IMERSÃO PRESENCIAL (3 dias) onde o aluno executa, com as próprias mãos, os procedimentos em que a formação capacita. <strong>Executa:</strong> os conservadores das 3 escadas (eletroestimulação, laser, liberação miofascial, exercícios) + o agulhamento (infiltração anestésica e dry needling). <strong>Indicação e teoria</strong> (domina o critério e encaminha; execução fica na mentoria): ácido hialurônico, corticoide, iPRF, toxina botulínica, artrocentese e os cirúrgicos. [Revisado pelo Rodrigo em 28/07]</em></li>
      <li><strong>Etapa 3 · Comercial, gestão e marketing básico (~2 meses · 8 encontros)</strong><em>Vender a abordagem terapêutica: narrativa da avaliação → tratamento, captação básica, retenção e números — fechando com a IMERSÃO PRESENCIAL final (2 dias): workshop de gestão/comercial/lucro + formatura + o convite natural pra mentoria.</em></li>
    ...
    <div class="alert amarelo">
      <strong>Pra validar nesta página (comentários abaixo):</strong> 1) a divisão 4 + 4-5 + 2 meses das etapas · 2) a faixa de investimento · 3) a distribuição dos outputs/ferramentas por encontro (calculadora, planilha, checklist) · 4) o desenho da mentoria como continuação técnica + negócio.
    </div>
  `,
},
...
OFERTA: {
  html: `
    ...
    <ul class="entregas-lista">
      <li><strong>43 encontros ao vivo, em grupo — 35 online + 3 imersões presenciais</strong><em>10 meses em 3 etapas: Diagnóstico → Tratamento → Comercial (grade completa aula a aula na página Grade).</em></li>
      <li><strong>3 imersões presenciais obrigatórias em Brasília, uma fechando cada etapa (8 dias de hands-on)</strong><em>Diagnóstico (palpação, medidas, integração diagnóstica) · Tratamento (execução supervisionada das técnicas em que a formação capacita) · Comercial (workshop de gestão/lucro + formatura). Cada imersão é, ao mesmo tempo, a prática mais densa da etapa e o gate de passagem de faixa, validado ao vivo pelo Rodrigo.</em></li>
      <li><strong>Estudo de caso todo mês + 3 gates presenciais</strong><em>✅ Modelo fechado com o Rodrigo (28/07): ritmo mensal em dois formatos. Nos primeiros meses, <strong>casos do próprio Rodrigo</strong> — a turma inteira analisa o mesmo caso e ele corrige uma vez só, discutindo ao vivo com todos. Depois que o aluno ganha preparo, passa a trazer <strong>casos reais do próprio consultório</strong>, com correção individual e mais profunda (os 4 marcos de correção individual seguem nos Encontros 7, 23, 27 e 31). Os 3 gates (um por etapa) acontecem dentro das imersões — o aluno prova que aprendeu fazendo, com as próprias mãos, não assistindo. 🔴 Distribuição encontro a encontro a detalhar.</em></li>
    ...
    <div class="card">
      <dl class="kv">
        ...
        <dt>1:1</dt><dd>Não há — o individual é diferencial da mentoria <em>✓ confirmado em 11/07</em></dd>
        ...
        <dt>Fica na mentoria</dt><dd>O AVANÇADO que escala: máquina de captação completa (tráfego, conteúdo, busca por IA) + a EXECUÇÃO dos procedimentos infiltrativos e invasivos (ácido hialurônico, corticoide, iPRF, toxina botulínica, artrocentese e cirúrgicos) — na formação o aluno domina a indicação e o encaminhamento desses; executa os conservadores e o agulhamento, com prática hands-on nas imersões</dd>
      </dl>
...
GRADE_ETAPAS: [
  {
    n: 1, titulo: 'Etapa 1 · Fundação e Diagnóstico', meta: '15 encontros · ~4 meses · faixa branca → azul',
    ...
    gate: 'GATE → faixa azul: dentro da imersão presencial que fecha a etapa (Encontro 15, dia 3), o aluno realiza o exame físico completo num paciente/voluntário real, integra com anamnese e imagem, e fecha o diagnóstico específico ao vivo, validado pelo Rodrigo no momento. "Eu sei diagnosticar" — a virada que separa quem acha que sabe de quem sabe.',
    faixa: 'azul',
    nota: 'A etapa fecha com a imersão presencial de 3 dias em Brasília (Encontros 13-15) — palpação hands-on, medidas de movimento e integração diagnóstica, terminando no GATE + cerimônia de faixa azul. ✅ GRAUS DA FAIXA BRANCA (modelo definido pelo Rodrigo em 02/08): os graus saem dos estudos de caso de DIAGNÓSTICO — o aluno sobe de grau a cada caso resolvido, com casos fornecidos pelo Rodrigo.',
  },
  {
    n: 2, titulo: 'Etapa 2 · Tratamento', meta: '20 encontros · ~4-5 meses · faixa azul → roxa',
    ...
    gate: 'GATE → faixa roxa: dentro da imersão presencial que fecha a etapa (Encontro 35, dia 3), o aluno recebe um caso misto real/voluntário, monta o plano escalonado completo e executa, sob supervisão, ao menos 1 técnica em que está capacitado — com marcação de execução × encaminhamento validada ao vivo. A virada de diagnosticador pra terapeuta.',
    faixa: 'roxa',
    nota: '✓ Marcação capacita × só-teoria REVISADA pelo Rodrigo (28/07, confirmada por escrito) — o aluno é capacitado a executar todos os conservadores + infiltração anestésica e dry needling; ácido hialurônico, corticoide, iPRF, toxina botulínica, artrocentese e os cirúrgicos ficam em indicação/teoria (execução na mentoria). ✅ Formato da prática de agulhamento FECHADO (28/07): rodízio entre os próprios alunos (cada receptor atende 2-3 operadores), com triagem pré-imersão medindo quantos receptores a turma tem e recrutamento externo só da diferença. ✅ GRAUS DA FAIXA AZUL (modelo definido pelo Rodrigo em 02/08): um grau por escada de TRATAMENTO — muscular, deslocamento de disco e articular — nos estudos de caso dos Encontros 23, 27 e 31, com casos fornecidos pelo Rodrigo. A etapa fecha com a imersão presencial de 3 dias (Encontros 33-35), onde o aluno executa as técnicas com as próprias mãos e passa pelo GATE + cerimônia de faixa roxa.',
  },
  {
    n: 3, titulo: 'Etapa 3 · Comercial, gestão e marketing básico', meta: '8 encontros · ~2 meses · faixa roxa → marrom/formatura',
    ...
    gate: 'GATE → formatura: dentro da imersão presencial final (Encontro 43, dia 2), o aluno conduz ao vivo, diante da turma, uma consulta de avaliação completa (avaliação → plano → fechamento) + apresenta o painel de números. Sabe tratar E sabe cobrar pelo que sabe.',
    faixa: 'marrom',
    nota: 'A etapa fecha com a imersão presencial final (Encontros 42-43): workshop de gestão/comercial/lucro (dia 1) seguido das apresentações finais, do GATE e da cerimônia de formatura + pitch da mentoria (dia 2). ✅ GRAUS DA FAIXA ROXA (modelo definido pelo Rodrigo em 02/08): aqui os casos passam a ser os DO PRÓPRIO ALUNO — ele traz pacientes reais do consultório dele, com correção individual. É a virada de "resolvo o caso que me dão" para "resolvo o meu caso", e fecha o arco que começou na faixa branca.',
  },
],
...
ENCONTROS: [
  ...
  // ETAPA 1 · Bloco 2 — Exame Físico Protocolar (preparação teórica)
  { n: 8,  etapa: 1, bloco: 'Bloco 2 · Exame Físico Protocolar — Preparação Teórica (1 semana)', titulo: 'O exame físico protocolar: o que a literatura pede', essencia: 'Palpação, sons articulares e medidas de movimento — a teoria balizada internacionalmente, em aula invertida, antes do hands-on.', output: 'Checklist do protocolo preenchido como roteiro pessoal pra levar à imersão presencial (Encontros 13-15).', fmt: 'online' },
  // ETAPA 1 · Bloco 3 — Imagem + Diagnóstico específico
  { n: 9,  etapa: 1, bloco: 'Bloco 3 · Imagem + Diagnóstico específico (4 semanas)', titulo: 'Interpretação de imagem (ressonância)', essencia: 'O que "dentista nenhum sabe ver": disco, degeneração, quando pedir imagem e quando ela é indispensável.', output: 'Laudo simplificado de 2 imagens apresentadas em aula.', fmt: 'online' },
  { n: 10, etapa: 1, bloco: 'Bloco 3 · Imagem + Diagnóstico específico (4 semanas)', titulo: 'Guarda-Chuva: grupo Muscular', essencia: 'Diferenciar os diagnósticos musculares integrando anamnese + exame + imagem — "por que não é articular? por que não é deslocamento?".', output: 'Diagnóstico justificado de 2 casos musculares, com descarte explícito dos outros grupos.', fmt: 'online' },
  { n: 11, etapa: 1, bloco: 'Bloco 3 · Imagem + Diagnóstico específico (4 semanas)', titulo: 'Guarda-Chuva: grupo Articular', essencia: 'Os diagnósticos articulares e seus achados típicos de imagem (degeneração, alterações ósseas).', output: 'Diagnóstico justificado de 2 casos articulares.', fmt: 'online' },
  { n: 12, etapa: 1, bloco: 'Bloco 3 · Imagem + Diagnóstico específico (4 semanas)', titulo: 'Guarda-Chuva: grupo Deslocamento de Disco', essencia: 'Com redução × sem redução; os achados de imagem característicos. Fecha o raciocínio diagnóstico à distância — a imersão que vem a seguir funde isso com a habilidade manual, em pacientes reais.', output: 'Diagnóstico justificado de 2 casos de deslocamento de disco.', fmt: 'online' },
  // ETAPA 1 · Bloco 4 — Imersão Presencial de Fechamento + GATE Faixa Azul
  { n: 13, etapa: 1, bloco: 'Bloco 4 · Imersão Presencial de Fechamento + GATE Faixa Azul (1 semana em Brasília)', titulo: 'Imersão presencial: palpação e sons articulares hands-on — dia 1', essencia: 'Palpação muscular e articular em pacientes/voluntários reais, com supervisão direta e rotação em estações de prática.', output: 'Ficha de exame físico preenchida ao vivo e validada pelo Rodrigo no momento.', fmt: 'presencial' },
  { n: 14, etapa: 1, bloco: 'Bloco 4 · Imersão Presencial de Fechamento + GATE Faixa Azul (1 semana em Brasília)', titulo: 'Imersão presencial: medidas de movimento e integração diagnóstica — dia 2', essencia: 'Medidas de movimento mandibular + integração com a palpação, a imagem e o guarda-chuva já ensinados online, formando hipótese diagnóstica em caso real.', output: 'Ficha completa (palpação + sons + medidas) de ao menos 2 casos reais, com hipótese diagnóstica validada pelo Rodrigo.', fmt: 'presencial' },
  { n: 15, etapa: 1, bloco: 'Bloco 4 · Imersão Presencial de Fechamento + GATE Faixa Azul (1 semana em Brasília)', titulo: 'GATE de diagnóstico + cerimônia de passagem de faixa azul — dia 3', essencia: 'Exame físico completo, sozinho, num caso nunca visto antes, com diagnóstico específico defensável apresentado ao vivo. ✅ Sourcing resolvido pela mesma lógica do agulhamento (28/07): a triagem pré-imersão mapeia quais alunos têm sinais de DTM, e como a palpação não é invasiva, o mesmo colega pode ser examinado por vários avaliadores em rodízio — basta parear quem ainda não se examinou. O Rodrigo complementa com 2-3 voluntários externos para garantir o critério de "nunca visto antes".', output: 'Diagnóstico específico com exame físico e justificativa clínica apresentados ao vivo — critério de aprovação da faixa azul.', fmt: 'presencial', nota: 'GATE presencial + cerimônia de passagem de faixa azul, diante da turma.' },
  // ETAPA 2 · Bloco 0 — Princípios
  { n: 16, etapa: 2, bloco: 'Bloco 0 · Princípios do Tratamento (2 semanas)', titulo: 'Multimodal, conservador escalonado e risco-benefício', essencia: 'Os 4 princípios filosóficos como critério de decisão — incluindo o próprio erro do Rodrigo ("já perdi a mão do momento de intervir") como caso de calibração. Abertura de etapa: feedback rápido da imersão que fechou a Etapa 1.', output: 'Primeira escolha terapêutica escrita pra 1 caso já diagnosticado (revisitada ao fim do bloco pra comparar evolução).', fmt: 'online' },
  { n: 17, etapa: 2, bloco: 'Bloco 0 · Princípios do Tratamento (2 semanas)', titulo: 'Timing de intervenção + Tripé Local aplicado', essencia: 'O critério dos 3-6 meses pra subir o degrau + o tripé local como primeira camada de qualquer plano, independentemente do diagnóstico.', output: 'Plano de intervenção do Tripé Local (dispositivo + consciência de hábito) pra 1 caso.', fmt: 'online' },
  // ETAPA 2 · Bloco 1 — Escada Muscular
  { n: 18, etapa: 2, bloco: 'Bloco 1 · Escada Muscular (6 semanas)', titulo: 'Conservador I: eletroestimulação, laser e liberação miofascial', essencia: 'Modalidades físicas conservadoras — indicação, parâmetros e técnica. [Teoria + indicação — prática hands-on na imersão, Encontro 33]', output: 'Checklist de parâmetros preenchido — roteiro técnico levado à estação de prática na imersão.', fmt: 'online' },
  { n: 19, etapa: 2, bloco: 'Bloco 1 · Escada Muscular (6 semanas)', titulo: 'Conservador II: controle do bruxismo (vigília e sono)', essencia: 'Biofeedback/eletromiografia, apps de consciência e dispositivo interoclusal — critérios de indicação e ajuste. [Teoria + indicação]', output: 'Prescrição completa de controle de bruxismo pra 2 casos (1 de vigília, 1 de sono).', fmt: 'online' },
  { n: 20, etapa: 2, bloco: 'Bloco 1 · Escada Muscular (6 semanas)', titulo: 'Conservador III: fármacos, exercícios e educação em dor', essencia: 'Farmacoterapia básica, exercícios caseiros e a educação em dor como ferramenta terapêutica em si. [Teoria + indicação]', output: 'Roteiro de educação em dor + prescrição + protocolo de exercícios pra 1 caso completo.', fmt: 'online' },
  { n: 21, etapa: 2, bloco: 'Bloco 1 · Escada Muscular (6 semanas)', titulo: 'Minimamente invasivo: infiltração anestésica e dry needling', essencia: 'Quando o conservador falha dentro do timing: indicação, técnica, cuidados e contraindicações. [Teoria + indicação — prática hands-on na imersão, Encontro 34]', output: 'Protocolo de decisão escrito pra 2 casos que não respondem ao conservador.', fmt: 'online' },
  { n: 22, etapa: 2, bloco: 'Bloco 1 · Escada Muscular (6 semanas)', titulo: 'Invasivo: a toxina no lugar certo da escada', essencia: 'A bandeira central do método: por que a toxina é o ÚLTIMO recurso, não o primeiro — "tem onda que é marola e tem onda que é tsunami". Só teoria: o aluno conhece a indicação e não executa.', output: 'Parecer escrito comparando casos de uso indevido com o caso de indicação correta.', fmt: 'online' },
  { n: 23, etapa: 2, bloco: 'Bloco 1 · Escada Muscular (6 semanas)', titulo: 'Estudo de caso: plano muscular completo (grau 1 na faixa azul)', essencia: 'Integra todo o bloco num plano escalonado do conservador ao invasivo.', output: 'Plano de tratamento escalonado completo da escada muscular, com timing e critério de subida.', fmt: 'caso' },
  // ETAPA 2 · Bloco 2 — Escada Deslocamento de Disco
  { n: 24, etapa: 2, bloco: 'Bloco 2 · Escada Deslocamento de Disco (4 semanas)', titulo: 'Conservador: exercícios de amplitude bucal', essencia: 'Protocolo de exercícios — técnica, frequência, progressão; por que essa escada é mais enxuta. [Teoria + indicação — prática hands-on na imersão, Encontro 33]', output: 'Protocolo de exercícios prescrito e demonstrado pra 1 caso.', fmt: 'online' },
  { n: 25, etapa: 2, bloco: 'Bloco 2 · Escada Deslocamento de Disco (4 semanas)', titulo: 'Minimamente invasivo: ácido hialurônico e artrocentese', essencia: 'O que cada procedimento resolve (lubrificação × lavagem articular). Ambos em indicação e teoria — o aluno reconhece o momento, explica ao paciente e encaminha; a execução fica na mentoria. [Revisado pelo Rodrigo em 28/07]', output: 'Ácido hialurônico: parecer marcando execução própria. Artrocentese: parecer de indicação.', fmt: 'online', nota: '✓ Confirmado pelo Rodrigo (10/07): ácido hialurônico capacita; artrocentese fica só teoria.' },
  { n: 26, etapa: 2, bloco: 'Bloco 2 · Escada Deslocamento de Disco (4 semanas)', titulo: 'Cirúrgico: artroscopia e discopexia — reconhecer o limite', essencia: 'O aluno não executa, mas sabe reconhecer o ponto cirúrgico, explicar ao paciente e encaminhar mantendo a relação terapêutica. [Indicação — só teoria]', output: 'Linha do tempo do caso anotada, com o ponto de encaminhamento marcado e justificado.', fmt: 'online' },
  { n: 27, etapa: 2, bloco: 'Bloco 2 · Escada Deslocamento de Disco (4 semanas)', titulo: 'Estudo de caso: plano completo — deslocamento de disco (grau 2 na faixa azul)', essencia: 'Integra o bloco, incluindo o ponto de encaminhamento quando aplicável.', output: 'Plano escalonado completo, com marcação explícita de executa × encaminha.', fmt: 'caso' },
  // ETAPA 2 · Bloco 3 — Escada Articular
  { n: 28, etapa: 2, bloco: 'Bloco 3 · Escada Articular (4 semanas)', titulo: 'Conservador: laserterapia, fármaco e crioterapia', essencia: 'As modalidades conservadoras do grupo articular — indicação, técnica e parâmetros. [Teoria + indicação — prática hands-on na imersão, Encontro 33]', output: 'Checklist de execução preenchido pra 1 caso articular, com os 3 recursos parametrizados.', fmt: 'online' },
  { n: 29, etapa: 2, bloco: 'Bloco 3 · Escada Articular (4 semanas)', titulo: 'Minimamente invasivo I: corticoide e artrocentese', essencia: 'Corticoide intra-articular (limites e riscos do uso repetido) + a mesma artrocentese com racional distinto do bloco anterior. Ambos em indicação e teoria — o aluno domina o critério de decisão e encaminha; a execução fica na mentoria. [Revisado pelo Rodrigo em 28/07]', output: 'Parecer escrito comparando a indicação de artrocentese nas 2 escadas, e a marcação do que executa (corticoide).', fmt: 'online' },
  { n: 30, etapa: 2, bloco: 'Bloco 3 · Escada Articular (4 semanas)', titulo: 'Minimamente invasivo II: iPRF por infiltração e ácido hialurônico', essencia: 'iPRF e ácido hialurônico em indicação e teoria — o aluno domina quando indicar, o que esperar de cada um e como conduzir o paciente; a execução (infiltração simples e variante guiada por ultrassom) fica na mentoria.', output: 'Ficha de indicação marcando o momento de cada procedimento e o ponto de encaminhamento.', fmt: 'online', nota: '✓ Revisado pelo Rodrigo (28/07) — ele reviu a marcação de 10/07: o aluno da formação NÃO executa as infiltrações. Confirmado por escrito ("Isso mesmo!") no WhatsApp.' },
  { n: 31, etapa: 2, bloco: 'Bloco 3 · Escada Articular (4 semanas)', titulo: 'Invasivo articular + estudo de caso: plano completo (grau 3 na faixa azul)', essencia: 'Indicações cirúrgicas (artroscopia, cirurgia aberta, prótese de ATM) em casos de degeneração avançada. [Indicação — só teoria]', output: 'Plano escalonado completo do grupo articular, com executa × encaminha por degrau.', fmt: 'caso' },
  // ETAPA 2 · Bloco 4 — Casos mistos (preparação)
  { n: 32, etapa: 2, bloco: 'Bloco 4 · Casos Mistos — Preparação (1 semana)', titulo: 'O paciente real tem mais de um diagnóstico', essencia: 'Sequenciar tratamento quando há sobreposição de grupos — qual degrau tratar primeiro quando há mais de uma escada em jogo. Prepara o raciocínio pro gate presencial da imersão.', output: 'Plano de tratamento integrado (multi-diagnóstico) pra 1 caso misto, com sequência justificada.', fmt: 'online' },
  // ETAPA 2 · Bloco 5 — Imersão Presencial de Fechamento + GATE Faixa Roxa
  { n: 33, etapa: 2, bloco: 'Bloco 5 · Imersão Presencial de Fechamento + GATE Faixa Roxa (1 semana em Brasília)', titulo: 'Imersão presencial: modalidades físicas conservadoras hands-on — dia 1', essencia: 'Eletroestimulação, laser, liberação miofascial e crioterapia executadas de fato, em rotação de estações, com correção de técnica em tempo real.', output: 'Checklist de execução validado pelo Rodrigo em cada estação.', fmt: 'presencial' },
  { n: 34, etapa: 2, bloco: 'Bloco 5 · Imersão Presencial de Fechamento + GATE Faixa Roxa (1 semana em Brasília)', titulo: 'Imersão presencial: agulhamento hands-on — dia 2', essencia: 'Infiltração anestésica e dry needling, com supervisão individual e apertada dado o risco técnico. ✅ Modelo de prática APROVADO pelo Rodrigo (28/07): prática entre os próprios alunos, em rodízio — cada receptor atende 2-3 operadores, então 4-6 receptores cobrem uma turma de 12. A triagem pré-imersão diz quantos receptores a turma tem, e o Rodrigo recruta de fora só a diferença (tipicamente 2-3 pessoas). A demonstração em paciente real fica reservada aos procedimentos que o aluno NÃO executa.', output: 'Checklist de execução validado individualmente pelo Rodrigo em cada procedimento.', fmt: 'presencial' },
  { n: 35, etapa: 2, bloco: 'Bloco 5 · Imersão Presencial de Fechamento + GATE Faixa Roxa (1 semana em Brasília)', titulo: 'Casos mistos hands-on + GATE de tratamento + cerimônia de faixa roxa — dia 3', essencia: 'Caso misto real ou voluntário: monta e executa, sob supervisão, o plano de tratamento escalonado completo.', output: 'Plano de tratamento com pelo menos 1 técnica executada sob supervisão + marcação execução × encaminhamento — critério de aprovação da faixa roxa.', fmt: 'presencial', nota: 'GATE presencial + cerimônia de passagem de faixa roxa, diante da turma.' },
  ...
  { n: 38, etapa: 3, bloco: 'Bloco 1 · Narrativa da Primeira Consulta (3 semanas)', titulo: 'Fechamento: da apresentação ao "sim"', essencia: 'Apresentar o investimento e responder às objeções do paciente ("é caro", "posso pensar") sem pressão agressiva — coerente com o tom educativo.', output: 'Script pessoal de fechamento pra usar na própria clínica na semana seguinte.', fmt: 'online' },
  // ETAPA 3 · Bloco 2 — Captação básica
  { n: 39, etapa: 3, bloco: 'Bloco 2 · Captação Básica (2 semanas)', titulo: 'Treinando a recepção: scripts lead → avaliação', essencia: 'A recepção como primeiro ponto de confiança — scripts pra converter contato em agendamento.', output: 'Script de atendimento pronto pra entregar à própria secretária.', fmt: 'online' },
  { n: 40, etapa: 3, bloco: 'Bloco 2 · Captação Básica (2 semanas)', titulo: 'Posicionamento e indicação', essencia: 'O canal mais barato e imediato de quem está começando — como comunicar a nova competência à própria base e rede.', output: 'Peça de comunicação pronta anunciando a nova competência.', fmt: 'online' },
  // ETAPA 3 · Bloco 3 — Retenção e Números
  { n: 41, etapa: 3, bloco: 'Bloco 3 · Retenção e Números (1 semana)', titulo: 'Pós-venda, contrato e os controles essenciais do funil', essencia: 'Ler os números (avaliações/mês, conversão, ticket) pra saber se o gargalo é captação, conversão ou execução clínica. Fio condutor: "sem número não tem estratégia".', output: 'Planilha de controles preenchida com números reais + meta projetada — material de base pro workshop da imersão final.', fmt: 'online' },
  // ETAPA 3 · Bloco 4 — Imersão Presencial Final
  { n: 42, etapa: 3, bloco: 'Bloco 4 · Imersão Presencial Final — Workshop de Gestão/Comercial/Lucro + Formatura (1 semana em Brasília)', titulo: 'Imersão presencial: workshop de gestão, comercial e lucratividade — dia 1', essencia: 'Precificação, produtividade de agenda e leitura do funil, mão na massa, com os números reais de cada aluno revisados pelo Rodrigo.', output: 'Planilha de precificação e meta comercial revisada e ajustada com o Rodrigo.', fmt: 'presencial' },
  { n: 43, etapa: 3, bloco: 'Bloco 4 · Imersão Presencial Final — Workshop de Gestão/Comercial/Lucro + Formatura (1 semana em Brasília)', titulo: 'Apresentações finais + GATE de formatura + cerimônia de faixa marrom — dia 2', essencia: 'Simulação completa da consulta de avaliação (acolhimento → devolutiva → plano → fechamento), diante da turma, + painel de baseline apresentado.', output: 'Condução ao vivo da consulta completa + planilha de controles apresentada — critério de aprovação da faixa final/formatura.', fmt: 'presencial', nota: 'GATE final + cerimônia de formatura (faixa marrom) + pitch da mentoria.' },
],
...
GRADE_TRANSVERSAIS: [
  ...
  { t: 'Estudo de caso mensal', d: '4 estudos de caso online (Encontros 7, 23, 27 e 31 — os de 23/27/31 também são graus na faixa azul) + os 3 gates presenciais que fecham cada etapa (Encontros 15, 35 e 43) — âncora do "aprender fazendo".' },
  { t: 'Gamificação por faixas', d: 'Passagem de faixa ao vivo, dentro da imersão presencial que fecha cada etapa (jiu-jitsu), com marco visível de evolução.' },
...
MENTORIA: {
  html: `
    ...
    <div class="alert">
      <strong>Papel estratégico na esteira:</strong> a mentoria protege a promessa da formação (o que é avançado não infla o produto 1) e cria o degrau natural de continuidade — o pitch dela é feito de dentro da jornada, no Encontro 43 (dia 2 da imersão presencial final), não como "mais uma oferta".
    </div>
  `,
},
...
COMPARACAO: [
  ...
  { c: 'Formato', f: 'Encontro semanal ao vivo (online) + 3 imersões presenciais (uma fecha cada etapa) + estudos de caso mensais', m: 'Discussão de casos reais (grupo e 1:1) + atualizações contínuas' },
  { c: 'Conteúdo técnico', f: 'As 3 escadas completas — conservador e minimamente invasivo executados na prática (imersões), até o nível "executa × encaminha"', m: 'Procedimentos avançados na prática (artrocentese, agregados por ultrassom guiado)' },
  ...
  { c: '1:1', f: 'Não há ✓ confirmado', m: 'Sim — discussão individual de casos reais' },
...
JORNADA: [
  {
    ...
    vive: ['Recebe boas-vindas e entende o mapa completo da jornada (as 3 fases + faixas)', 'Conhece os colegas de turma (cohort)', 'Recebe o material de apoio inicial (ficha de 40 perguntas, template de mapa mental)', 'Agenda as 3 imersões presenciais'],
    ganhos: null,
    marco: null,
    checkpoint: null,
  ...
  },
  {
    ...
    objetivo: 'O momento mais denso E mais recompensador da Fase 1: palpação hands-on, sons articulares, medidas de movimento e integração diagnóstica em paciente real — tudo sob supervisão direta e validação ao vivo do Rodrigo, terminando no GATE.',
    vive: ['Dias 1-2: rotação em estações de prática, em pequenos grupos', 'Só avança quem demonstra a técnica corretamente na frente dele', 'Dia 3: GATE presencial — diagnóstico de um caso real ou voluntário nunca visto antes, sozinho, diante do Rodrigo', 'Fecha com a cerimônia de passagem de faixa azul, diante de toda a turma'],
    ganhos: null, marco: null, checkpoint: null,
    risco: 'É também o momento mais vulnerável — aprender a palpar e ser avaliado ao vivo, com o próprio gate de faixa em jogo, exige coragem de expor a própria dificuldade técnica.',
    antidoto: 'Sem competição nem "desafio" entre colegas na imersão (regra do brief de gamificação) — cada aluno é avaliado só em relação ao próprio gate. O formato é supervisão e validação individual, não disputa.',
  },
  {
    tipo: 'fase', quando: 'Encontros 16 a 35 · ~4-5 meses', nome: 'Fase 2 · "De quem nomeia o problema a quem resolve o problema"', proposta: true, faixas: ['azul', 'roxa'], hl: false,
    objetivo: 'Deixar de "saber nomear" e passar a "saber tratar com julgamento clínico, com as próprias mãos" — plano escalonado pros 3 grupos, sabendo quando executar e quando encaminhar. A fase mais densa da jornada.',
    vive: ['Semanas 1-2: os 4 princípios do método + o critério objetivo de quando subir de degrau', 'Semanas 3-8: a teoria e a indicação da escada MUSCULAR inteira — do conservador à toxina (com a bandeira: ela é o ÚLTIMO recurso)', 'Semanas 9-12: a escada de DESLOCAMENTO DE DISCO — até reconhecer o limite cirúrgico e encaminhar com segurança', 'Semanas 13-16: a escada ARTICULAR — conservador, minimamente invasivo e o reconhecimento do invasivo', 'Semana 17: prepara o raciocínio pra casos MISTOS — o desafio mais realista, porque o paciente real raramente é caso de livro', 'Semana final (fecha a fase): IMERSÃO PRESENCIAL em Brasília (3 dias) — toda a teoria das 3 escadas vira habilidade manual, em rotação de estações, terminando no GATE e na cerimônia de faixa roxa'],
    ...
    marco: 'GATE faixa azul → roxa (Encontro 35, dia 3 da imersão presencial que fecha a fase): o aluno recebe um caso misto real/voluntário, monta o plano escalonado completo e executa, sob supervisão, ao menos 1 técnica em que está capacitado, com sequência, timing e execução × encaminhamento demonstrados ao vivo.',
    checkpoint: ['Formativa: 3 estudos de caso (Encontros 23, 27, 31) — cada escada fecha com plano corrigido individualmente e marca um grau na faixa azul', 'Somativa: o GATE presencial do Encontro 35 substitui o antigo estudo de caso assíncrono por uma demonstração hands-on ao vivo, com pelo menos 1 técnica executada sob supervisão', 'Antes/depois: o registro bruto do Encontro 16 (a escolha terapêutica antes de ver as escadas) revisitado no fim da fase — o aluno se confronta com o próprio ponto de partida'],
    risco: 'A fase mais longa e tecnicamente pesada (20 encontros) — sobrecarga cognitiva na virada de uma escada pra outra; e a bandeira anti-botox (Encontro 22) pode gerar fricção com quem já usa toxina no consultório.',
    antidoto: 'Cada escada fecha com estudo de caso próprio — conclusão parcial a cada 4-6 semanas, não só no fim. O confronto do Encontro 22 é conduzido como o Rodrigo desenhou: "tsunamizinho", não acusação. A imersão de fechamento, com 8 técnicas hands-on em 3 dias, também funciona como recompensa concentrada pra uma fase tecnicamente pesada.',
  },
  {
    tipo: 'fase', quando: 'Encontros 36 a 43 · ~2 meses', nome: 'Fase 3 · "De quem sabe tratar a quem sabe cobrar pelo que sabe fazer"', proposta: true, faixas: ['roxa', 'marrom'], hl: false,
    ...
    vive: ['Semanas 1-3: a consulta de avaliação como ato terapêutico E comercial — devolutiva, plano com os Dois Tripés, fechamento', 'Semanas 4-5: scripts pra própria recepção + comunicação simples de posicionamento/indicação, sem tráfego pago', 'Semana 6: pós-venda e os controles essenciais — o primeiro painel de gestão que ele mesmo vai manter', 'Semana final (fecha a fase): IMERSÃO PRESENCIAL final em Brasília (2 dias) — workshop de gestão/comercial/lucro no dia 1, seguido da simulação completa e da faixa final no dia 2, com o pitch da mentoria como continuidade natural'],
    ...
    marco: 'GATE faixa roxa → marrom/formatura (Encontro 43, dia 2 da imersão presencial final): consulta de avaliação completa conduzida ao vivo, diante da turma, com os scripts construídos + painel de números de baseline apresentado.',
    checkpoint: ['Formativa: scripts entregues e ensaiados em role-play (Encontros 36-38), com feedback antes da aplicação real', 'Somativa: 1ª avaliação cobrada com o script novo e/ou 1º tratamento fechado com a narrativa dos Dois Tripés — dinheiro entrando por causa do que ele aprendeu', 'Métrica do mundo real: painel de baseline com números REAIS da própria clínica + meta projetada pros 3 meses seguintes'],
  ...
  {
    tipo: 'momento', quando: 'Dentro do Encontro 43 · imersão presencial final', nome: 'Formatura + ponte para a mentoria', faixas: ['marrom'], hl: true,
    ...
    antidoto: 'O painel de baseline (Encontros 41-42) já é o "e agora" concreto — o aluno sai com meta de 3 meses pra rodar sozinho; e a comunidade construída em 10 meses sustenta o intervalo até a mentoria abrir.',
  },
],
...
GAMIFICACAO: {
  ...
  visao_geral: [
    ...
    { faixa: 'azul', nome: 'Faixa Azul', quando: 'Encontro 15 (imersão presencial, dia 3) · 16 semanas depois', diz: '"Eu diagnostico."' },
    { faixa: 'roxa', nome: 'Faixa Roxa', quando: 'Encontro 35 (imersão presencial, dia 3) · 18 semanas depois', diz: '"Eu trato."' },
    { faixa: 'marrom', nome: 'Faixa Marrom · Formatura', quando: 'Encontro 43 (imersão presencial, dia 2) · 7-8 semanas depois', diz: '"Eu cobro pelo que sei."' },
  ],
  ...
  graus: {
    ...
    rows: [
      { marco: 'Faixa azul, 1º grau', quando: 'Encontro 23 — fim da Escada Muscular', criterio: 'Estudo de caso nº 2 aprovado: plano escalonado completo da escada muscular, com sequência e critério de subida corretos.' },
      { marco: 'Faixa azul, 2º grau', quando: 'Encontro 27 — fim da Escada de Deslocamento de Disco', criterio: 'Estudo de caso nº 3 aprovado, com marcação execução × encaminhamento correta.' },
      { marco: 'Faixa azul, 3º grau', quando: 'Encontro 31 — fim da Escada Articular', criterio: 'Estudo de caso nº 4 aprovado.' },
      { marco: 'Faixa roxa', quando: 'Encontro 35 — dia 3 da imersão presencial que fecha a Fase 2', criterio: 'Plano escalonado completo pra um caso misto real/voluntário, com pelo menos 1 técnica executada sob supervisão — cerimônia completa, na própria imersão.' },
    ],
  },
  marcos: [
    ...
    { faixa: 'azul', nome: 'Graus 1-2-3 da faixa azul', faz: 'Entrega e aprova os estudos de caso mensais 2, 3 e 4 (fechamento de cada escada de tratamento).', valida: 'Rodrigo — correção individual já prevista no plano de ensino.', recebe: 'Reconhecimento verbal em aula + atualização no painel de progresso. Nenhum item físico — o grau é registro, não objeto.', sustenta: 'Ritmo de entrega na fase mais longa e pesada — cada escada fechada é uma vitória visível, não um silêncio de 18 semanas.' },
    { faixa: 'azul', nome: 'Faixa Azul (Encontro 15, imersão presencial, dia 3)', faz: 'Realiza o exame físico completo num paciente/voluntário real, integra com anamnese e imagem, e entrega diagnóstico específico defensável nos 3 grupos do guarda-chuva, com justificativa clínica apresentada ao vivo.', valida: 'Rodrigo — validação presencial em tempo real, critério do plano de ensino.', recebe: 'Cerimônia ao vivo diante da turma, na própria imersão + faixa azul física ou digital + certificado nominal de "1ª faixa: Diagnóstico" (nome a validar).', sustenta: 'Consolida presença + entrega consistente ao longo da Fase 1, coroada por uma demonstração hands-on real — a faixa reconhece um histórico, não um teste isolado de sorte.' },
    { faixa: 'roxa', nome: 'Faixa Roxa (Encontro 35, imersão presencial, dia 3)', faz: 'Recebe um caso misto real/voluntário e monta o plano de tratamento escalonado completo, executando sob supervisão ao menos 1 técnica em que está capacitado, com sequência, timing e execução × encaminhamento.', valida: 'Rodrigo — validação presencial em tempo real, critério do plano de ensino.', recebe: 'Cerimônia ao vivo diante da turma, na própria imersão + faixa roxa + certificado nominal de "2ª faixa: Tratamento" (nome a validar).', sustenta: 'Consolida aplicação clínica progressiva, comprovada com as próprias mãos — a faixa reconhece julgamento clínico treinado, não decoreba de procedimento.' },
    { faixa: 'marrom', nome: 'Faixa Marrom · Formatura (Encontro 43, imersão presencial, dia 2)', faz: 'Conduz ao vivo, diante da turma, a simulação completa da consulta de avaliação usando os scripts construídos + apresenta o painel de números de baseline da própria clínica.', valida: 'Rodrigo — validação presencial, critério do plano de ensino.', recebe: 'Cerimônia de formatura ao vivo, com ponte pra mentoria + faixa marrom + certificado de conclusão da Formação + convite formal à mentoria.', sustenta: 'Fecha o ciclo prometido — competência clínica virando receita — e consolida a identidade de "dentista que diagnostica, trata e cobra por isso".' },
  ],
  ...
  cerimonia: {
    ...
    passos: [
      'A cerimônia acontece DENTRO da imersão presencial que fecha cada etapa (não é evento à parte, nem depende de plataforma online) — no fim do último dia de imersão, depois que o gate presencial de cada aluno já foi validado ao vivo. A validação técnica individual acontece durante o dia; a cerimônia, no fechamento dele, é reconhecimento coletivo, não hora de dar nota.',
  ...
  anti_armadilhas_confirma: [
    ...
    { el: 'Competição/desafios entre colegas na imersão presencial', pq: 'Desde a reestruturação de 3 imersões (11/07), as 3 passagens de faixa acontecem DENTRO das imersões (Encontros 15, 35 e 43) — isso é desenho, não armadilha: o gate técnico individual, validado ao vivo, é o tipo de reconhecimento que este sistema defende. O que continua proibido é transformar as estações de prática em competição entre colegas (quem termina mais rápido, ranking de técnica) — cada aluno é avaliado só em relação ao próprio gate.' },
  ],
  regras_operacionais: [
