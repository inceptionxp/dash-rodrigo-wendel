...
GRADE_ETAPAS: [
  ...
  },
  {
    ...
    faixa: 'roxa',
    nota: '✓ Marcação capacita × só-teoria REVISADA pelo Rodrigo (28/07, confirmada por escrito) — o aluno é capacitado a executar todos os conservadores + infiltração anestésica e dry needling; ácido hialurônico, corticoide, iPRF, toxina botulínica, artrocentese e os cirúrgicos ficam em indicação/teoria (execução na mentoria). 🔴 Formato da prática de agulhamento a definir: o Rodrigo levantou que não consegue garantir um paciente por aluno. Os graus da faixa azul saem nos estudos de caso dos Encontros 23, 27 e 31; a etapa fecha com a imersão presencial de 3 dias (Encontros 33-35), onde o aluno executa essas técnicas com as próprias mãos e passa pelo GATE + cerimônia de faixa roxa.',
  },
  {
...
ENCONTROS: [
  ...
  { n: 34, etapa: 2, bloco: 'Bloco 5 · Imersão Presencial de Fechamento + GATE Faixa Roxa (1 semana em Brasília)', titulo: 'Imersão presencial: agulhamento hands-on — dia 2', essencia: 'Infiltração anestésica e dry needling, com supervisão individual e apertada dado o risco técnico. 🔴 Formato de prática a definir com o Rodrigo (28/07): prática entre os próprios alunos, demonstração em rotação, ou paciente real conforme disponibilidade — ele levantou que não consegue garantir um paciente por aluno.', output: 'Checklist de execução validado individualmente pelo Rodrigo em cada procedimento.', fmt: 'presencial' },
