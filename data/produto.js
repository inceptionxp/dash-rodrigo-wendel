...
FORMACAO: {
  html: `
    ...
    <ul class="entregas-lista">
      ...
      <li><strong>Etapa 2 · Tratamento (~4-5 meses · 20 encontros)</strong><em>Os dois tripés aplicados + as 3 escadas de tratamento (muscular, articular, deslocamento de disco), diagnóstico a diagnóstico, do conservador ao invasivo + timing de intervenção — fechando com a IMERSÃO PRESENCIAL (3 dias) onde o aluno executa, com as próprias mãos, os procedimentos em que a formação capacita. Só toxina botulínica, artrocentese e os procedimentos cirúrgicos ficam em teoria/indicação — o resto (eletroestimulação, laser, liberação miofascial, dry needling, infiltração anestésica, ácido hialurônico, iPRF por infiltração, corticoide) o aluno sai executando.</em></li>
  ...
  html: `
    ...
    <div class="card">
      <dl class="kv">
        ...
        <dt>Fica na mentoria</dt><dd>O AVANÇADO que escala: máquina de captação completa (tráfego, conteúdo, busca por IA) + os poucos procedimentos que ficam só em teoria na formação (toxina botulínica, artrocentese, cirúrgicos, iPRF guiado por ultrassom) — os outros, o aluno já sai executando, com prática hands-on nas imersões</dd>
      </dl>
...
GRADE_ETAPAS: [
  ...
  },
  {
    ...
    faixa: 'roxa',
    nota: '✓ Marcação capacita × só-teoria FECHADA pelo Rodrigo (10/07) e já aplicada na grade — o aluno é capacitado a executar todos os conservadores + infiltração anestésica, dry needling, ácido hialurônico, corticoide e iPRF por infiltração simples; só toxina botulínica, artrocentese e os procedimentos cirúrgicos ficam em indicação/teoria. Os graus da faixa azul saem nos estudos de caso dos Encontros 23, 27 e 31; a etapa fecha com a imersão presencial de 3 dias (Encontros 33-35), onde o aluno executa essas técnicas com as próprias mãos e passa pelo GATE + cerimônia de faixa roxa.',
  },
  {
...
ENCONTROS: [
  ...
  { n: 25, etapa: 2, bloco: 'Bloco 2 · Escada Deslocamento de Disco (4 semanas)', titulo: 'Minimamente invasivo: ácido hialurônico e artrocentese', essencia: 'O que cada procedimento resolve (lubrificação × lavagem articular). Ácido hialurônico: o aluno SAI CAPACITADO (prática na imersão). Artrocentese: só teoria — conhece a indicação e encaminha.', output: 'Ácido hialurônico: parecer marcando execução própria. Artrocentese: parecer de indicação.', fmt: 'online', nota: '✓ Confirmado pelo Rodrigo (10/07): ácido hialurônico capacita; artrocentese fica só teoria.' },
  ...
  { n: 29, etapa: 2, bloco: 'Bloco 3 · Escada Articular (4 semanas)', titulo: 'Minimamente invasivo I: corticoide e artrocentese', essencia: 'Corticoide intra-articular (limites e riscos do uso repetido) + a mesma artrocentese com racional distinto do bloco anterior. Corticoide: capacita (prática na imersão). Artrocentese: só teoria (conhece e encaminha).', output: 'Parecer escrito comparando a indicação de artrocentese nas 2 escadas, e a marcação do que executa (corticoide).', fmt: 'online' },
  { n: 30, etapa: 2, bloco: 'Bloco 3 · Escada Articular (4 semanas)', titulo: 'Minimamente invasivo II: iPRF por infiltração e ácido hialurônico', essencia: 'iPRF por infiltração simples e ácido hialurônico: o aluno SAI CAPACITADO (prática na imersão). Agregado plaquetário guiado por ultrassom: alta complexidade, fica só teoria — reservado pra mentoria.', output: 'Ficha de indicação marcando o que é infiltração simples (executa) e o que é variante guiada por ultrassom (encaminha/mentoria).', fmt: 'online', nota: '✓ Confirmado pelo Rodrigo (10/07) — resolve a pendência anterior sobre o iPRF.' },
  ...
  { n: 34, etapa: 2, bloco: 'Bloco 5 · Imersão Presencial de Fechamento + GATE Faixa Roxa (1 semana em Brasília)', titulo: 'Imersão presencial: infiltrações e minimamente invasivos hands-on — dia 2', essencia: 'Infiltração anestésica, dry needling, ácido hialurônico, corticoide e iPRF por infiltração simples — supervisão individual e apertada, dado o risco técnico.', output: 'Checklist de execução validado individualmente pelo Rodrigo em cada procedimento.', fmt: 'presencial' },
